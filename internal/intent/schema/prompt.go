...
var FewShot = []Example{
	...
	},
	{
		...
		JSON:   `{"seeds":["Bonobo"],"mode":"similar","count":30,"creativity":0.85,"noise":0.2,"lookback":1,"exclude_artists":["Skrillex"],"no_repeat_artist":true,"notes":"Adventurous, downtempo deep cuts around Bonobo, no Skrillex."}`,
	},
}
