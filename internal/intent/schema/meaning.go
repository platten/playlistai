...
var exclusionPrefixPattern = regexp.MustCompile(`(?i)\b(?:do not include|don't include|don’t include|do not play|don't play|do not want|don't want|don’t want|neither|nor|no|not|without|avoid|skip|excluding|exclude|except|nothing by|nothing from)\b`)
