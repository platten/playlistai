...
install_dir=${2:?FFmpeg install directory required}
payload_dir=${3:?payload directory required}
...

{
  ...
  printf '\nEnabled network protocols: none\nEnabled protocols: file, pipe\n'
...
{
  "schemaVersion": 1,
  "id": "ffmpeg-8.1.2-linux-amd64-minimal-v1",
  ...
  "configure": [
    ...
    "--enable-filter=aresample,anull,aformat", "--enable-encoder=pcm_f32le",
